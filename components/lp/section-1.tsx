            ...
            <div className="w-full max-w-[1200px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
                ...
                >
                    <div className="relative rounded-[2rem] overflow-hidden aspect-[4/5] shadow-2xl border border-border/40 group">
                        <Image
                            src="/image1.png"
                            alt="Atendimento presencial Âncora Corretora Nova Iguaçu"
                            fill
                        ...
                        >
                            <span className="p-1 rounded-md bg-emerald-500/10 text-emerald-600 shrink-0">
                ...
                >
                    ...
                    <p className="text-muted-foreground text-sm sm:text-base leading-relaxed mb-6 font-light">
                        Não somos um robô de vendas sem suporte. A <strong className="text-foreground font-semibold">Âncora Corretora</strong> possui sede própria no Centro de Nova Iguaçu e atende clientes em todo o Rio de Janeiro com suporte humano do primeiro atendimento ao pós-venda.
                    </p>
