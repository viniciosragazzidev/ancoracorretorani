    ...
    return (
        <section className="relative w-full overflow-hidden bg-background pt-24 pb-20 md:pt-32 md:pb-28 font-sans flex items-center min-h-[100dvh]" style={{ perspective: '1000px' }}>
            ...
            <div className="absolute inset-0 -z-10 flex items-center justify-center pointer-events-none">
                <div className="absolute top-0 right-0 w-[800px] h-[800px] rounded-full bg-blue-500/5 blur-[150px] dark:bg-blue-600/10" />
                <div className="absolute bottom-0 left-0 w-[600px] h-[600px] rounded-full bg-emerald-500/5 blur-[150px] dark:bg-emerald-600/10" />
            </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-28 relative z-10 grid lg:grid-cols-[1.1fr_1fr] xl:grid-cols-[1.2fr_1fr] gap-12 items-center">
                ...
                <div className="flex flex-col items-start text-left w-full">
                    ...
                    <motion.div
                        ...
                        variants={fadeLeft}
                        custom={0}
                        className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-700 dark:text-emerald-400 text-[11px] sm:text-xs font-semibold mb-8 select-none shadow-sm backdrop-blur-sm"
                    >
