                        ...
                        >
                            <AnimatePresence mode="wait">
                                {isSuccess ? (
                                    ...
                                    >
                                        <div className="size-14 rounded-full bg-emerald-500/10 text-emerald-600 flex items-center justify-center mb-5">
                                        ...
                                        {step === 2 && (
                                            <div className="space-y-6">
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                    ...
                                                    >
                                                        <span className="absolute top-3 right-3 inline-flex items-center px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-600 text-[9px] font-bold select-none">
                                                            Mais Econômico
                                                        </span>
                                                        <div className="space-y-1.5">
