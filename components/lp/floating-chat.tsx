        ...
        <div className="fixed bottom-5 right-5 z-[80] font-sans flex flex-col items-end select-none pointer-events-none">
            ...
            <div className="relative flex flex-col items-end pointer-events-auto">
                            ...
                            <div className="p-4 sm:p-5 border-b border-border/40 flex items-center justify-between bg-muted/30">
                                <div className="flex items-center gap-3">
                                    <div className="relative">
                                        <div className="size-10 rounded-full bg-emerald-500/10 flex items-center justify-center text-xl shadow-xs border border-emerald-500/20">
                                            👩‍⚕️
                                        </div>
                ...
                <motion.button
                    ...
                    className={`relative size-14 rounded-full bg-emerald-600 hover:bg-emerald-500 text-white shadow-2xl flex items-center justify-center transition-all cursor-pointer border-2 border-white/20 z-30 ${
