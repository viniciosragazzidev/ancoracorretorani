                            ...
                            <div className="lg:col-span-7 space-y-6">
                                ...
                                <div className="pt-3">
                                    <Button
                                        ...
                                        className="h-12 px-6 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-sm shadow-md cursor-pointer flex items-center gap-2 transition-all active:scale-[0.98]"
                                    >
