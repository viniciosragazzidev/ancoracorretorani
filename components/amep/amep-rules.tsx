                    ...
                    {rules.map((rule, idx) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="rounded-3xl p-6 bg-card border border-border/70 hover:border-emerald-500/40 transition-all flex flex-col justify-between text-left shadow-xs group space-y-6"
                            >
