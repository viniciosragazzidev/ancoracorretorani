                ...
                <div className="rounded-3xl bg-background border border-border/80 p-6 sm:p-10 shadow-2xl relative overflow-hidden text-left">
                    ...
                    <div className="flex items-center justify-between mb-8 pb-6 border-b border-border/40">
                        <div className="flex items-center gap-2">
                            <span className={`size-7 rounded-full flex items-center justify-center text-xs font-bold ${step >= 1 ? 'bg-emerald-600 text-white' : 'bg-muted text-muted-foreground'}`}>1</span>
                            <span className="text-xs font-semibold text-foreground hidden sm:inline">Modalidade</span>
                        </div>
                        <div className={`h-0.5 flex-1 mx-3 ${step >= 2 ? 'bg-emerald-600' : 'bg-border/60'}`} />
                        <div className="flex items-center gap-2">
                            <span className={`size-7 rounded-full flex items-center justify-center text-xs font-bold ${step >= 2 ? 'bg-emerald-600 text-white' : 'bg-muted text-muted-foreground'}`}>2</span>
                            <span className="text-xs font-semibold text-foreground hidden sm:inline">Perfil & Vidas</span>
                        </div>
                        <div className={`h-0.5 flex-1 mx-3 ${step >= 3 ? 'bg-emerald-600' : 'bg-border/60'}`} />
                        <div className="flex items-center gap-2">
                            <span className={`size-7 rounded-full flex items-center justify-center text-xs font-bold ${step === 3 ? 'bg-emerald-600 text-white' : 'bg-muted text-muted-foreground'}`}>3</span>
                        ...
                        {step === 1 && (
                            ...
                            >
                                ...
                                <div className="flex justify-end pt-4">
                                    <Button
                                        onClick={() => setStep(2)}
                                        className="h-11 px-6 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-sm shadow-md cursor-pointer flex items-center gap-2"
                                    >
