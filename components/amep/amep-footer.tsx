            ...
            <div className="w-full max-w-[1320px] mx-auto px-4 sm:px-6">
                        ...
                        <ul className="space-y-3 text-xs sm:text-sm font-light">
                            <li>
                                <a 
                                    ...
                                    className="flex items-center gap-2.5 hover:text-white transition-colors duration-200 text-emerald-400 font-semibold"
                                >
                            ...
                            <li>
                                <a 
                                    href="mailto:contato@ancoracorretora.com.br"
                                ...
                                >
                                    ...
                                    <span className="truncate">contato@ancoracorretora.com.br</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="mt-8 pt-8 border-t border-neutral-900 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-[10px] sm:text-xs text-neutral-500 font-light text-center md:text-left leading-relaxed">
                        © 2026 Âncora Corretora de Seguros. Registro ANS nº 413330 (AMEP Saúde). Todos os direitos reservados.
                    </p>
