...
const depoimentos = [
    {
        ...
        text: "Fechei o plano Amep para mim e meus 2 filhos pelo WhatsApp da Âncora. No mesmo mês precisei levar meu filho ao Hospital Prontonil e o atendimento foi rápido, sem pagar nada a mais!",
        rating: 5,
    ...
    },
    {
        name: "Camila Ribeiro",
        local: "Nova Iguaçu - RJ",
        text: "Fui muito bem atendida na sede da Âncora no Centro de Nova Iguaçu. A carência zero para consultas salvou minha rotina médica. Recomendo demais!",
        rating: 5,
        ...
        <section className="w-full py-16 sm:py-24 bg-background border-b border-border/40 font-sans select-none">
            <div className="w-full max-w-[1320px] mx-auto px-4 sm:px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    {depoimentos.map((item, idx) => (
                        <motion.div
                            ...
                            className="rounded-3xl p-6 bg-card border border-border/70 hover:border-emerald-500/40 transition-all flex flex-col justify-between text-left shadow-xs space-y-6"
                        >
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-[10px] font-extrabold uppercase tracking-wider text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 px-2.5 py-0.5 rounded-md">
                                        {item.badge}
                                    </span>
                                </div>
                ...
                <motion.div 
                    ...
                    className="rounded-3xl bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 p-6 sm:p-10 text-white shadow-xl flex flex-col md:flex-row items-center justify-between gap-6 text-left relative overflow-hidden"
                >
                    <div className="space-y-2 max-w-2xl">
                        ...
                        <p className="text-xs sm:text-sm text-white/90 font-light leading-relaxed">
                            Contratando hoje com a Âncora Corretora, você não paga nenhuma taxa de adesão extra e garante liberação imediata para consultas na rede própria Amep Saúde.
                        </p>
                    </div>
                    ...
                    <Button
                        ...
                        size="lg"
                        className="h-13 px-6 rounded-2xl bg-white text-emerald-800 hover:bg-emerald-50 font-extrabold text-sm shadow-lg shrink-0 cursor-pointer flex items-center gap-2 transition-all active:scale-[0.98]"
                    >
