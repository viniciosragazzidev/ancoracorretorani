            ...
            <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6">
                ...
                >
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center space-y-4">
                        <div className="size-16 sm:size-20 rounded-full bg-emerald-600/90 text-white flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform duration-300 ring-4 ring-emerald-500/30">
                        ...
                        <div className="text-center space-y-1">
                            ...
                            <span className="text-emerald-400 text-xs sm:text-sm font-medium block">
