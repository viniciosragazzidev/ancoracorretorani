...
export default function AmepHero() {
    ...
    return (
        <section className="relative w-full min-h-[100dvh] pt-24 pb-16 md:pt-32 md:pb-24 flex items-center justify-center bg-background overflow-hidden border-b border-border/40 font-sans select-none" style={{ perspective: '1000px' }}>
            ...
            <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-emerald-500/10 blur-[150px] rounded-full pointer-events-none -z-10" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="lg:col-span-7 flex flex-col items-start text-left space-y-6">
                        ...
                        <motion.div
                            ...
                            variants={fadeLeft}
                            custom={0}
                            className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-700 dark:text-emerald-400 text-xs font-semibold shadow-2xs backdrop-blur-sm"
                        >
                        ...
                        >
                            <div className="flex items-center gap-2.5 bg-background px-4 py-1.5 rounded-full border border-border/40 shadow-2xs">
                                <Image src="/logo.webp" alt="Âncora Corretora" width={85} height={26} className="h-5 sm:h-6 w-auto object-contain dark:brightness-0 dark:invert" priority />
                        ...
                        >
                            ...
                            <motion.div 
                                ...
                                whileHover={{ y: -4, scale: 1.02 }}
                                transition={{ type: "spring", stiffness: 300 }}
                                className="bg-emerald-500/10 backdrop-blur-md border border-emerald-500/30 hover:border-emerald-500/60 rounded-2xl p-4 sm:p-5 shadow-xs hover:shadow-md transition-all flex flex-col justify-between relative overflow-hidden"
                            >
                    ...
                    >
                        <div className="relative rounded-3xl bg-background/80 dark:bg-background/70 backdrop-blur-2xl border border-border/40 p-6 sm:p-8 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.15)] overflow-hidden">
                            ...
                            <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-emerald-500/60 via-teal-500/60 to-emerald-500/60" />
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4 text-left">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-4 py-3 rounded-xl border border-border/70 bg-muted/20 focus:bg-background focus:border-emerald-500 outline-none transition-all text-sm font-medium text-foreground placeholder:font-normal placeholder:text-muted-foreground/60 shadow-2xs"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            className="w-full pl-10 pr-4 py-3 rounded-xl border border-border/70 bg-muted/20 focus:bg-background focus:border-emerald-500 outline-none transition-all text-sm font-medium text-foreground appearance-none cursor-pointer shadow-2xs"
                                        >
                                ...
                                <Button
                                    ...
                                    className="w-full h-14 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-base shadow-xl shadow-emerald-600/20 transition-all active:scale-[0.98] cursor-pointer flex items-center justify-center gap-2 mt-4"
                                >
                                    {isSubmitting ? (
